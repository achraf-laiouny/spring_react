    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-6 d-flex justify-content-center">
          {!data.img?<></>:<img className='productimg'  width="167" height="250" src={`/images/${data.img}`} alt="Product Image"/>}
        </div>
          ...
          <div className="product-dtl">
            <div className="product-info">
              ...
              <div className="product-price-discount">
                <span>MAD {data.price}</span>
                <span className="line-through">MAD {data.price+100}</span>
              </div>
            </div>
            <p>
